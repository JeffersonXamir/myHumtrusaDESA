...
<%@ attribute
	...
	required="false"
	description="
( Object source, String recordId, Mixed value, Mixed oldValue )Fires before a property value changes.Handlers can return false to cancel the property change(this will internally call Ext.data.Record.reject on the propertys record).
" %>
