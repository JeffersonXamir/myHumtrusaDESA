...
<%@ attribute
	...
	required="false"
	description="
(Boolean)True to initialize this checkbox as checked (defaults to false). Note that if this checkbox is part of a radio group (group = true) only the last item in the group that is initialized with checked = true will be rendered as checked.
" %>
...
<%@ attribute
	...
	required="false"
	description="
(String)All check items with the same group name will automatically be grouped into a single-select radio button group (defaults to )
" %>
...
<%@ attribute
	...
	required="false"
	description="
(String)The default CSS class to use for radio group check items (defaults to x-menu-group-item)
" %>
...
<%@ attribute
	...
	required="false"
	description="
(String)The href attribute to use for the underlying anchor link (defaults to #).
" %>
...
<%@ attribute
	...
	required="false"
	description="
(String)The target attribute to use for the underlying anchor link (defaults to ).
" %>
...
<%@ attribute
	...
	required="false"
	description="
(String)The path to an icon to display in this item (defaults to Ext.BLANK_IMAGE_URL). If icon is specified iconCls should not be.
" %>
...
<%@ attribute
	...
	required="false"
	description="
(String)A CSS class that specifies a background image that will be used as the icon for this item (defaults to ). If iconCls is specified icon should not be.
" %>
...
<%@ attribute
	...
	required="false"
	description="
(String)The default CSS class to use for check items (defaults to x-menu-item x-menu-check-item)
" %>
...
<%@ attribute
	...
	required="false"
	description="
(Number)Length of time in milliseconds to wait before showing this item (defaults to 200)
" %>
...
<%@ attribute
	...
	required="false"
	description="
(String)The text to display in this item (defaults to ).
" %>
...
<%@ attribute
	name="onBeforecheckchange"
	type="java.lang.Boolean"
	required="false"
	description="
( Ext.menu.CheckItem this, Boolean checked )Fires before the checked value is set, providing an opportunity to cancel if needed
" %>
...
<%@ attribute
	...
	required="false"
	description="
( Ext.menu.CheckItem this, Boolean checked )Fires after the checked value has been set
" %>
