...
<%@ attribute
	...
	required="false"
	description="
(Boolean)If set to true then reselecting a color that is already selected fires the selection event
" %>
...
<%@ attribute
	...
	required="false"
	description="
(String)The CSS class to apply to the containing element (defaults to x-color-palette)
" %>
...
<%@ attribute
	...
	required="false"
	description="
(String)The initial color to highlight (should be a valid 6-digit color hex code without the # symbol). Note that the hex codes are case-sensitive.
" %>
...
<%@ attribute
	...
	required="false"
	description="
( ColorPalette this, String color )Fires when a color is selected
" %>
