...
<%@ attribute
	...
	required="false"
	description="
( Object This, Object o, Object arg )Fires before the load methods callback is called.
" %>
...
<%@ attribute
	...
	required="false"
	description="
(Number)(Optional) The timeout in milliseconds to be used for requests. (defaults to 30000)
" %>
...
<%@ attribute
	...
	required="false"
	description="
(String)(Optional) The default URL to be used for requests to the server. (defaults to undefined)
" %>
