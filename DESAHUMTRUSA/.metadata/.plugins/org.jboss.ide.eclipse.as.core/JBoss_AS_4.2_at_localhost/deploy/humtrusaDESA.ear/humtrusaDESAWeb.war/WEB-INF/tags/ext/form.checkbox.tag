...
<%@ attribute
	...
	required="false"
	description="
	(Long)Usado para los combos de la forma de pago. 
	"
 %>
<%@ attribute
	name="allowDomMove"
...
<%@ attribute
	...
	required="false"
	description="
(String)The default CSS class for the checkbox (defaults to x-form-field)
" %>
...
<%@ attribute
	...
	required="false"
	description="
(String)The CSS class to use when the checkbox receives focus (defaults to undefined)
" %>
...
<%@ tag 
	...
	<c:if test="${empty(fieldLabel)}">
		<jsp:doBody var="fieldLabel" scope="page" />
	</c:if>
