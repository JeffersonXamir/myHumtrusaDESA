...
<%@ attribute
	...
	required="false"
	description="
(String)Multiple date formats separated by | to try when parsing a user input value and it doesnt match the defined format (defaults to m/d/Y|m-d-y|m-d-Y|m/d|m-d|d).
" %>
...
<%@ attribute
	...
	required="false"
	description="
(String)The error text to display when the time is after maxValue (defaults to The time in this field must be equal to or before {0}).
" %>
...
<%@ attribute
	...
	required="false"
	description="
(String)The error text to display when the date in the cell is before minValue (defaults to The time in this field must be equal to or after {0}).
" %>
...
<%@ attribute
	...
	required="false"
	description="
(String)A CSS class to apply to the trigger
" %>
