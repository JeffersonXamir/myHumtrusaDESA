...
<%@ attribute
	...
	type="java.lang.String"
	required="false"
	description="(String)The base CSS class to apply to the progress bars wrapper element (defaults to x-progress)" %>
...
<%@ attribute
	...
	required="false"
	description="
(String)The progress bar elements id (defaults to an auto-generated id)
" %>
...
<%@ attribute
	...
	required="false"
	description="
(Mixed)The element to render the progress text to (defaults to the progress bars internal text element)
" %>
