...
<%@ attribute
	...
	required="false"
	description="
(Boolean)True to render a close tool button into the tooltip header (defaults to false).
" %>
...
<%@ attribute
	...
	required="false"
	description="
(String)Experimental. The default Ext.Element.alignTo anchor position value for this tip relative to its element of origin (defaults to tl-bl?).
" %>
...
<%@ attribute
	...
	required="false"
	description="
(Number)Delay in milliseconds after the mouse exits the target element but before the tooltip actually hides (defaults to 200). Set to 0 for the tooltip to hide immediately.
" %>
...
<%@ attribute
	...
	required="false"
	description="
(Number)The maximum width of the tip in pixels (defaults to 300).
" %>
...
<%@ attribute
	...
	required="false"
	description="
(Number)The minimum width of the tip in pixels (defaults to 40).
" %>
...
<%@ attribute
	...
	required="false"
	description="
(Array)An XY offset from the mouse position where the tooltip should be shown (defaults to [15,18]).
" %>
...
<%@ attribute
	...
	required="false"
	description="
(Number)Delay in milliseconds before the tooltip displays after the mouse enters the target element (defaults to 500)
" %>
...
<%@ attribute
	...
	required="false"
	description="
(Mixed)The target HTMLElement, Ext.Element or id to associate with this tooltip.
" %>
...
<%@ attribute
	...
	required="false"
	description="
(Boolean)True to have the tooltip follow the mouse as it moves over the target element (defaults to false).
" %>
