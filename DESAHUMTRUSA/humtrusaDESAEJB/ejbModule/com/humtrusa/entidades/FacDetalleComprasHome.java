...
public class FacDetalleComprasHome {
	...
	public FacDetalleCompras merge(FacDetalleCompras detachedInstance) {
		...
		try {
			FacDetalleCompras result = (FacDetalleCompras) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public List findByExample(FacDetalleCompras instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.humtrusa.entidades.FacDetalleCompras")
