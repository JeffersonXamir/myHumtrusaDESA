...
public class GenagenciasHome {
	...
	public Genagencias merge(Genagencias detachedInstance) {
		...
		try {
			Genagencias result = (Genagencias) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public List findByExample(Genagencias instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.humtrusa.entidades.Genagencias")
