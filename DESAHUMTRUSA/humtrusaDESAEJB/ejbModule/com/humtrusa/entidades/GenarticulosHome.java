...
public class GenarticulosHome {
	...
	public Genarticulos merge(Genarticulos detachedInstance) {
		...
		try {
			Genarticulos result = (Genarticulos) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public List findByExample(Genarticulos instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.humtrusa.entidades.Genarticulos")
