...
public class GenlineasHome {
	...
	public Genlineas merge(Genlineas detachedInstance) {
		...
		try {
			Genlineas result = (Genlineas) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Genlineas findById(java.lang.Long id) {
		log.debug("getting Genlineas instance with id: " + id);
		try {
			Genlineas instance = (Genlineas) sessionFactory.getCurrentSession().get("com.humtrusa.entidades.Genlineas",
					id);
			if (instance == null) {
	...
	public List findByExample(Genlineas instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.humtrusa.entidades.Genlineas")
