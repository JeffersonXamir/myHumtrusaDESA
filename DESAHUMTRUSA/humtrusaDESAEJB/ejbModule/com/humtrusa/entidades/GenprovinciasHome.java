...
public class GenprovinciasHome {
	...
	public Genprovincias merge(Genprovincias detachedInstance) {
		...
		try {
			Genprovincias result = (Genprovincias) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public List findByExample(Genprovincias instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.humtrusa.entidades.Genprovincias")
