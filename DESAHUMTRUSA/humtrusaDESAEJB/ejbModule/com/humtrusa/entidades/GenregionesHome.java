...
public class GenregionesHome {
	...
	public Genregiones merge(Genregiones detachedInstance) {
		...
		try {
			Genregiones result = (Genregiones) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public List findByExample(Genregiones instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.humtrusa.entidades.Genregiones")
