...
public class UsuariosxagenciaHome {
	...
	public Usuariosxagencia merge(Usuariosxagencia detachedInstance) {
		...
		try {
			Usuariosxagencia result = (Usuariosxagencia) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public List findByExample(Usuariosxagencia instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.humtrusa.entidades.Usuariosxagencia")
