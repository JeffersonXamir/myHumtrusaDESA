...
import com.humtrusa.daoext.GenParametrosDAOEXT;
...
public class BAdministracionArticulos implements BAdministracionArticulosLocal {
    ...
    public String listarArticuloPedido(long codempresa, long codarticulo,String descripcion) {
		System.out.println("listarArticuloPedido "+codempresa +" "+ codarticulo+" "+ descripcion);
		...
		try{
			...
			GenParametrosDAOEXT daopar = new GenParametrosDAOEXT();
			...
			if(lista!=null && lista.size()>0){
				...
				for (Object[] obj : lista) {
					...
					strBuff.append("<codarticulo>"+art.getCodarticulo()+"</codarticulo>");
					...
					strBuff.append("<iva>"+daopar.obtenerParametroGeneral(codempresa, "IVA_GLOBAL")+"</iva>");
					strBuff.append("</articulo>");
