...
public class Genestados implements java.io.Serializable {
	...
	public Genestados(String descripcion, String codusuario, Date fecha, Set genperfileses, Set genarticulosxempresas,
			Set genusuarioses, Set genopcioneses, Set usuariosxagencias, Set facOrdenesCompras, Set genregioneses,
			Set genciudadeses, Set genprovinciases, Set genunidadesmedidas, Set genagenciases) {
		this.descripcion = descripcion;
		this.codusuario = codusuario;
		this.fecha = fecha;
