...
public class GenperfilesHome {
	...
	public Genperfiles merge(Genperfiles detachedInstance) {
		...
		try {
			Genperfiles result = (Genperfiles) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public List findByExample(Genperfiles instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.humtrusa.entidades.Genperfiles")
