...
public class GensublineasdosHome {
	...
	public Gensublineasdos merge(Gensublineasdos detachedInstance) {
		...
		try {
			Gensublineasdos result = (Gensublineasdos) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public List findByExample(Gensublineasdos instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.humtrusa.entidades.Gensublineasdos")
