...
public class InvstockHome {
	...
	public Invstock merge(Invstock detachedInstance) {
		...
		try {
			Invstock result = (Invstock) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Invstock findById(com.humtrusa.entidades.InvstockId id) {
		...
		try {
			Invstock instance = (Invstock) sessionFactory.getCurrentSession().get("com.humtrusa.entidades.Invstock",
					id);
			if (instance == null) {
	...
	public List findByExample(Invstock instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.humtrusa.entidades.Invstock")
