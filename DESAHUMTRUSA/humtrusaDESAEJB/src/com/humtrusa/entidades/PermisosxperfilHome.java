...
public class PermisosxperfilHome {
	...
	public Permisosxperfil merge(Permisosxperfil detachedInstance) {
		...
		try {
			Permisosxperfil result = (Permisosxperfil) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public List findByExample(Permisosxperfil instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.humtrusa.entidades.Permisosxperfil")
